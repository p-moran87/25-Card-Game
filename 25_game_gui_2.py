...
class TwentyFiveGUI(Frame):
	...
	def _newGame(self):
		...
		self._playerCard1 = Button(self, image=self._playerImages[0], state=ACTIVE)
		self._playerCard1.grid(row = 10, column = 0, columnspan = 1)
		self._playerCard2 = Button(self, image=self._playerImages[1], state=ACTIVE)
		self._playerCard2.grid(row = 10, column = 1, columnspan = 1)
		self._playerCard3 = Button(self, image=self._playerImages[2], state=ACTIVE)
		self._playerCard3.grid(row = 10, column = 2, columnspan = 1)
		self._playerCard4 = Button(self, image=self._playerImages[3], state=ACTIVE)
		self._playerCard4.grid(row = 10, column = 3, columnspan = 1)
		self._playerCard5 = Button(self, image=self._playerImages[4], state=ACTIVE)
		self._playerCard5.grid(row = 10, column = 4, columnspan = 1)
